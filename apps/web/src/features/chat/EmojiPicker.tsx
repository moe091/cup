...
import { DEFAULT_UNICODE_EMOJIS } from "./constants/unicodeEmojis";
...
export default function EmojiPicker({
  ...
  return (
    <div
      className="absolute bottom-full right-0 z-20 mb-2 w-[320px] rounded-xl border border-[color:var(--line)] bg-[color:var(--panel-strong)] p-3 shadow-[0_12px_30px_rgba(0,0,0,0.35)]"
    >
      <p className="mb-2 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">Standard</p>
      ...
      <p className="mb-2 mt-3 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">Custom</p>
